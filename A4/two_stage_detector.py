...
def generate_fpn_anchors(
    ...
    ###
    # print('loc device', locations_per_fpn_level['p3'].device)
    ###
...
class RPN(nn.Module):
    ...
    def forward(
        ...
        ###
        # print('gtbox shape', gt_boxes.shape, num_images)
        ###
        ######################################################################
...
class FasterRCNN(nn.Module):
    ...
    def forward(
        ...
        for level_name in feats_per_fpn_level.keys():
            ...
            # Replace "pass" statement with your code
            # Tensor[num_proposals, fpn_channels, roi_size[0], roi_size[1]]
        ...
        ###
        # print(gt_labels.shape, fgbg_logits.shape)
        # print(gt_labels.dtype, gt_labels.device)
        # exit()
        ###
